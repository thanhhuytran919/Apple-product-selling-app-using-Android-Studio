...
public class DangKiActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(DangKiActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                              if (task.isSuccessful()){
                                  ...
                                  if(user != null){
                                      postData(str_email, str_pass, str_username, str_numberphone, user.getUid());
                                  }
                              } else {
    ...
    private  void postData(String str_email, String str_pass, String str_username, String str_numberphone, String uid){
        //pass data
        compositeDisposable.add(apiBanHang.dangKi(str_email,str_pass,str_username,str_numberphone, uid)
